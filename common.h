...
enum {
  ...
  BACKGROUND_ICON_DONE,  // Motorola, r42707, 25/11/2009, IKMAP-1478
...
// Displays additional text below progress bar. 
// The text consists of two parts: left-aligned ltText and right-aligned rtText. 
// If text is null, no text is displayed (standard behavior)
// Should be called before ui_show_progress and ui_set_progress
// Cleared (set to null) by ui_reset_progress
void ui_set_progress_text(const char* ltText, const char* rtText);
